...
mod_statusbar.create{
    ...
    -- windows and icons.
    --
    template="%date | load: %>load | batt: %>laptopstatus_batterypercent %laptopstatus_batterytimeleft | mail: %>nmaild_allnew/%>nmaild_allread | %>lastirc %filler%systray",
